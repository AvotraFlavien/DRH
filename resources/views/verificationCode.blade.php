              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" method="POST">
                  ...
                  <div class="mt-3" style = "text-align: center;">
                    <a class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn"  id="myButton" href="ddds">Suivant</a>
                  </div>
                  </div>
                </form>
              </div>
...
button.addEventListener('click', function() {
    ...
    axios.post('http://127.0.0.1:8000/api/user/verification/code/'+userId, {
        code: nameValue,
    })
      .then(response => {
